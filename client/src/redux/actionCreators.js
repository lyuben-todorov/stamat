import { SERVER_START_MATCHMAKING, SERVER_REPLY_MATCHUP, GAME_PLAYER_READY, GAME_PLAYER_MOVE, SERVER_REGISTER_USER, GAME_CONCEDE, GAME_OFFER_DRAW } from "../actions";
